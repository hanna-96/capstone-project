...
if ("serviceWorker" in navigator) {
  window.addEventListener("load", () => {
    const wb = new workbox_window__WEBPACK_IMPORTED_MODULE_0__["Workbox"]("/public/sw.js");
    const updateButton = document.querySelector("#app-update"); // Fires when the registered service worker has installed but is waiting to activate.
...
/******/ });
//# sourceMappingURL=main.1442679ee3cc9e065569.js.map